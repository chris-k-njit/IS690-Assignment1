...
class QRCodeRequest(BaseModel):
    url: HttpUrl = Field(..., description="The URL to encode into the QR code.") # Needs to be URL, not ul like underline in HTML
...
class QRCodeResponse(BaseModel):
    message: str = Field(..., description="A message related to the QR code request.") # this is a message, adjusting this here.
